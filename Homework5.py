...
print(my_dict)
mini_dict = ('hospital', 'policeman', 'food', 'sword art online') # mini_dict = (set(my_dict.keys())) - способ достать ключи, не выписывая вручную. Можно превращать как во множество, так и в список или кортеж.
...
if user_word in mini_dict:
    print('Перевод: ', my_dict[user_word])
else:
